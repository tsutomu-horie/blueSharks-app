...
class MemberScreen extends GetView<MemberController> {
        ...
        children: [
          ...
          Obx(() {
            List<CategorizedPlayerGroup> groupedPlayers = memberController
                .groupPlayersByCategory(controller.categoryPlayers);
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final MemberGroup playerGroup =
                            group.playerGroups[index];
                            ...
                            Padding(
                              ...
                              child: GridView.builder(
                                ...
                                itemBuilder: (context, playerIndex) {
                                  final player =
                                      playerGroup.players[playerIndex];
  ...
  Widget PlayerCard(Member player) {
    ...
    return FutureBuilder<String>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return InkWell(
            onTap: () {
              controller.navigateToMemberDetail(player);
            },
            child: Stack(
              children: [
                postImage != '' ?
  ...
  void showPlayerFilterBottomSheet(MemberController memberController, BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
          ...
          height: 190.h, // Fixed height for the bottom sheet
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              SizedBox(height: 8.h),
