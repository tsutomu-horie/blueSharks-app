            ...
            child: Column(
              children: [
                ...
                Obx(() {
                  ...
                  final nextMatchData =
                      homeController.threeLatestMatch.value;
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: nextMatchData.map((element) {
                            final gameDate =
                                element.custom_field.gameDate ?? [];
                            final gameTime =
                                element.custom_field.gameTime ?? [];
                            final location =
                                element.custom_field.location ?? [];
                            final gameSerial =
                ...
                GetBuilder<HomeController>(
                  ...
                  builder: (controller) {
                    return BannerSliderView(
                      key: ValueKey(
                          'banner_${controller.bannerData.length}'),
                  ...
                  return Column(
                    children: data.map((element) {
                      return FutureBuilder<String>(
                        future:
                        homeController.getNewsImage("${element.id}"),
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                              ConnectionState.waiting) {
                            return Padding(
                            ...
                            return TopicItemView(
                              ...
                              title: element.title.rendered,
                              categories:
                              mapCategoryIdsToNames(element.categories),
                            );
                          } else {
