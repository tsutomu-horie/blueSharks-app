          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: CustomTextView("1/3", type: TDSFontType.labelLarge, color: BrandColor.main,),
              ),
              SizedBox(width: 16.w,),
            ],
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    SizedBox(width: 16.w,),
                    Flexible(child: CustomTextView(LocaleKeys.set_wallpaper_title.tr, type: TDSFontType.headlineSmall, color: BrandColor.main,)),
                    SizedBox(width: 16.w,),
                  ],
                ),
                SizedBox(height: 8.w,),
                Row(
                  children: [
                    SizedBox(width: 16.w,),
                    Flexible(child: CustomTextView(LocaleKeys.set_wallpaper_desc3.tr, type: TDSFontType.bodyTextMedium, color: TextColor.secondary,)),
                    SizedBox(width: 16.w,),
                  ],
                ),
