...
class InfoDetailScreen extends GetView<InfoDetailController> {
  const InfoDetailScreen(this.onOpenDetail, this.selectedPost, {super.key});
  ...
  Widget build(BuildContext context) {
    final InfoDetailController controller = Get.put(InfoDetailController());
