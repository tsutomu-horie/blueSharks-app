...
import 'controllers/player_list.controller.dart';

class PlayerListScreen extends GetView<PlayerListController> {
  const PlayerListScreen(this.onSet, {super.key});
  final Function(String, String)? onSet;

  @override
  Widget build(BuildContext context) {
    final PlayerListController memberController = Get.put(PlayerListController());
